...
Index of ADRs under `docs/adr/`. Numbering is sequential.
...
| [010](./010-frontend-parity-scope.md) | Frontend Parity Scope: F.20–F.31 | Proposed | — | — |
...
| [027](./027-runtime-model-switching-forwards-switch-llm.md) | Runtime model switching — BFF forwards only `switch_llm`, blast-radius-minimized (Stage 6.5.2) | Ratified (2026-08-06) | — | — |
| [028](./028-stage-7-deviation-topology-first-capability-slices-renumbered.md) | Stage 7 deviation — topology-first reconciliation (§7.1 + §7.4 now), canonical §7.2–§7.6 folded to deferred tail §7.6–§7.10, Council-Synthesis capability slices renumbered to Stage 8 (8.0–8.9); 30/500 SWE-bench gate waived for Stage-6→Stage-7 transition | Ratified (2026-08-06) | Amends `docs/reconciliation-plan-v1.md` §7 and §Recommended Execution Order (item 7); adopts workspace-draft companion as `docs/reconciliation-plan-stage-7.md` | — |
| [029](./029-sdk-native-adoption-for-stage-8.md) | Stage 8 SDK-native adoption — ADOPT `openhands.sdk.skills` + `openhands.sdk.context.condenser` + `openhands.sdk.workspace` (Skills/Condenser/Workspace); Slice 8.1 HYBRID (adopt Workspace, hand-build pytest outcome schema); Slice 8.2 HYBRID (adopt Workspace, hand-build bounded-N repair loop); Slice 8.6 ADOPT SDK Skills wholesale + hand-build token-budget gate (2 slices → 1 slice) | Ratified (2026-08-06) | ADR-028 §4 (mandated the SDK-native investigation spike); supersedes specific slice sizings in `Forge-OH-Improvements-Research-Model-Council-Synthesis.md` for §8.1 / §8.2 / §8.6 | — |
