...
| [013](./013-qwen36-27b-canonical-coder-planner.md) | Canonical planner (ratified) + coder deferred to Path F | Amended · Planner ratified 2026-08-05 · Coder deferred | ADR-009 §2 (planner-selection layer only) | — |
