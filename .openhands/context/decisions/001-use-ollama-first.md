...
> **STATUS AMENDMENT (2026-08-04):** This is a stale scaffold copy of ADR-001
> from the initial `.openhands/context/` bootstrap (see
> [`docs/AUDIT-LOG.md`](../../../docs/AUDIT-LOG.md) row 3). The **canonical**
> ADR-001 lives at [`../../decisions/001-use-ollama-first.md`](../../decisions/001-use-ollama-first.md).
> This file is **superseded by ADR-009 for the F.19+ router** — see
> [`docs/adr/009-local-llm-selection.md`](../../../docs/adr/009-local-llm-selection.md).
> Do NOT edit this file; edit the canonical copy in `.openhands/decisions/` instead.

**Status**: Amended · superseded by ADR-009 (canonical copy in `.openhands/decisions/`)  
**Date**: 2026-07-01
